...
SPREAD_THRESHOLD = 0.6      # عتبة الفجوة المئوية لفتح الصفقة
TP_PERCENT_OF_GAP = 0.30     # هدف الربح: 80% من الفجوة الأولية
SL_PERCENT_OF_GAP = -0.25    # وقف الخسارة: 50% خسارة من الفجوة الأولية
